...
#define OV5645b_VOLTAGE_ANALOG               2800000
#define OV5645b_VOLTAGE_DIGITAL_CORE         1500000
#define OV5645b_VOLTAGE_DIGITAL_IO           2800000

#define MIN_FPS 15
#define MAX_FPS 30
#define DEFAULT_FPS 30

#define OV5645b_XCLK_MIN 6000000
#define OV5645b_XCLK_MAX 24000000
#define OV5645b_XCLK_20MHZ 20000000

#define OV5645b_CHIP_ID_HIGH_BYTE	0x300A
#define OV5645b_CHIP_ID_LOW_BYTE		0x300B

enum ov5645b_mode {
	ov5645b_mode_MIN = 0,
	ov5645b_mode_VGA_640_480 = 0,
	ov5645b_mode_NTSC_720_480 = 1,
	ov5645b_mode_720P_1280_720 = 2,
	ov5645b_mode_1080P_1920_1080 = 3,
	ov5645b_mode_QSXGA_2592_1944 = 4,
	ov5645b_mode_MAX = 5,
	ov5645b_mode_INIT = 0xff, /*only for sensor init*/
};

enum ov5645b_frame_rate {
	ov5645b_15_fps,
	ov5645b_30_fps
};

static int ov5645b_framerates[] = {
	[ov5645b_15_fps] = 15,
	[ov5645b_30_fps] = 30,
};

struct ov5645b_datafmt {
	u32	code;
 ...
 */
enum ov5645b_downsize_mode {
	SUBSAMPLING,
	SCALING,
};

enum ov5645b_af_mode {
	ov5645b_af_release = 0,
	ov5645b_af_lock = 1,
	ov5645b_af_cont = 2,
};
...
struct ov5645b_mode_info {
	enum ov5645b_mode mode;
	enum ov5645b_downsize_mode dn_mode;
	u32 width;
	u32 height;
...
struct ov5645b {
	...
	const struct ov5645b_datafmt	*fmt;
	...
	enum ov5645b_frame_rate loaded_fps;
	enum ov5645b_mode loaded_mode;
	bool initialized;
};
 ...
 */
static struct ov5645b ov5645b_data;
static int pwn_gpio, rst_gpio;
static int chip_id;

struct ov5645b_res ov5645b_valid_res[] = {
	[0] = {640, 480},
	[1] = {720, 480},
	[2] = {1280, 720},
	[3] = {1920, 1080},
...
static struct reg_value ov5645b_af_setting[] = {
...
static struct reg_value ov5645b_init_setting_30fps_VGA[] = {
...
static struct reg_value ov5645b_setting_30fps_VGA_640_480[] = {
	{0x3103, 0x11, 0, 0},
...
static struct reg_value ov5645b_setting_30fps_NTSC_720_480[] = {
	{0x3103, 0x11, 0, 0},
//	Comment this out in order for AF to work
//	{0x3008, 0x82, 0, 0},
	{0x3008, 0x42, 0, 0},	{0x3103, 0x03, 0, 0},	{0x3503, 0x07, 0, 0},
...
static struct reg_value ov5645b_setting_30fps_720P_1280_720[] = {
	{0x3103, 0x11, 0, 0},
//	Comment this out in order for AF to work
//	{0x3008, 0x82, 0, 0},
	{0x3008, 0x42, 0, 0},	{0x3103, 0x03, 0, 0},	{0x3503, 0x07, 0, 0},
...
static struct reg_value ov5645b_setting_30fps_1080P_1920_1080[] = {
	{0x3103, 0x11, 0, 0},
//	Comment this out in order for AF to work
//	{0x3008, 0x82, 0, 0},
	{0x3008, 0x42, 0, 0},	{0x3103, 0x03, 0, 0},	{0x3503, 0x07, 0, 0},
...
static struct reg_value ov5645b_setting_15fps_1080P_1920_1080[] = {
	{0x3103, 0x11, 0, 0},
//	Comment this out in order for AF to work
//	{0x3008, 0x82, 0, 0},
	{0x3008, 0x42, 0, 0},	{0x3103, 0x03, 0, 0},	{0x3503, 0x07, 0, 0},
...
static struct reg_value ov5645b_setting_15fps_QSXGA_2592_1944[] = {
	{0x3103, 0x11, 0, 0},
//	Comment this out in order for AF to work
//	{0x3008, 0x82, 0, 0},
	{0x3008, 0x42, 0, 0},	{0x3103, 0x03, 0, 0},	{0x3503, 0x07, 0, 0},
...
static struct ov5645b_mode_info ov5645b_mode_info_data[2][ov5645b_mode_MAX + 1] = {
	{
		{ov5645b_mode_VGA_640_480, -1, 0, 0, NULL, 0},
		{ov5645b_mode_NTSC_720_480, -1, 0, 0, NULL, 0},
		{ov5645b_mode_720P_1280_720, -1, 0, 0, NULL, 0},
		{ov5645b_mode_1080P_1920_1080, SUBSAMPLING, 1920, 1080,
		ov5645b_setting_15fps_1080P_1920_1080,
		ARRAY_SIZE(ov5645b_setting_15fps_1080P_1920_1080)},
		{ov5645b_mode_QSXGA_2592_1944, SCALING, 2592, 1944,
		ov5645b_setting_15fps_QSXGA_2592_1944,
		ARRAY_SIZE(ov5645b_setting_15fps_QSXGA_2592_1944)},
	},
	{
		{ov5645b_mode_VGA_640_480, SUBSAMPLING, 640,  480,
		ov5645b_setting_30fps_VGA_640_480,
		ARRAY_SIZE(ov5645b_setting_30fps_VGA_640_480)},
		{ov5645b_mode_NTSC_720_480, SUBSAMPLING, 720, 480,
		ov5645b_setting_30fps_NTSC_720_480,
		ARRAY_SIZE(ov5645b_setting_30fps_NTSC_720_480)},
		{ov5645b_mode_720P_1280_720, SUBSAMPLING, 1280, 720,
		ov5645b_setting_30fps_720P_1280_720,
		ARRAY_SIZE(ov5645b_setting_30fps_720P_1280_720)},
		{ov5645b_mode_1080P_1920_1080, SCALING, 1920, 1080,
		ov5645b_setting_30fps_1080P_1920_1080,
		ARRAY_SIZE(ov5645b_setting_30fps_1080P_1920_1080)},
		{ov5645b_mode_QSXGA_2592_1944, -1, 0, 0, NULL, 0},
	},
};
...
static int ov5645b_probe(struct i2c_client *adapter,
				const struct i2c_device_id *device_id);
static int ov5645b_remove(struct i2c_client *client);

static s32 ov5645b_read_reg(u16 reg, u8 *val);
static s32 ov5645b_write_reg(u16 reg, u8 val);

static const struct i2c_device_id ov5645b_id[] = {
	{"ov5645b_mipi", 0},
	{},
};

MODULE_DEVICE_TABLE(i2c, ov5645b_id);

static struct i2c_driver ov5645b_i2c_driver = {
	.driver = {
		  .owner = THIS_MODULE,
		  .name  = "ov5645b_mipi",
		  },
	.probe  = ov5645b_probe,
	.remove = ov5645b_remove,
	.id_table = ov5645b_id,
};

static const struct ov5645b_datafmt ov5645b_colour_fmts[] = {
...
static int get_capturemode(int width, int height)
{
	...
	for (i = 0; i < ARRAY_SIZE(ov5645b_valid_res); i++) {
		if ((ov5645b_valid_res[i].width == width) &&
		     (ov5645b_valid_res[i].height == height))
			return i;
	}
...
static struct ov5645b *to_ov5645b(const struct i2c_client *client)
{
	return container_of(i2c_get_clientdata(client), struct ov5645b, subdev);
}

/* Find a data format by a pixel code in an array */
static const struct ov5645b_datafmt
			*ov5645b_find_datafmt(u32 code)
{
	int i;

	for (i = 0; i < ARRAY_SIZE(ov5645b_colour_fmts); i++)
		if (ov5645b_colour_fmts[i].code == code)
			return ov5645b_colour_fmts + i;

	return NULL;
}

static inline void ov5645b_power_down(int enable)
{
	if (pwn_gpio < 0)
		return;
...
static void ov5645b_reset(void)
{
...
static int ov5645b_regulator_enable(struct device *dev)
{
	int ret = 0;
...
static s32 ov5645b_write_reg(u16 reg, u8 val)
{
	...
	if (i2c_master_send(ov5645b_data.i2c_client, au8Buf, 3) < 0) {
...
static s32 ov5645b_read_reg(u16 reg, u8 *val)
{
	...
	if (2 != i2c_master_send(ov5645b_data.i2c_client, au8RegBuf, 2)) {
		pr_err("%s:write reg error:reg=%x\n",
				__func__, reg);
		return -1;
	}

	if (1 != i2c_master_recv(ov5645b_data.i2c_client, &u8RdVal, 1)) {
...
static void ov5645b_release_af(void)
{
	ov5645b_write_reg(0x3022, 0x08);
}

static void ov5645b_enable_cont_af(void)
{
	ov5645b_release_af();
	ov5645b_write_reg(0x3022, 0x12);
	ov5645b_write_reg(0x3022, 0x04);
}

static void ov5645b_lock_af(void)
{
	u8 temp;
	int cnt = 40;
	...
	ov5645b_release_af();
	ov5645b_write_reg(0x3022, 0x12);
	ov5645b_write_reg(0x3022, 0x03);
	do {
		ov5645b_read_reg(0x3029, &temp);
		msleep(50);
...
static void OV5645b_stream_on(void)
{
	ov5645b_write_reg(0x3008, 0x02);
	ov5645b_write_reg(0x4202, 0x00);
	ov5645b_enable_cont_af();
}

static void OV5645b_stream_off(void)
{
	ov5645b_release_af();
	ov5645b_write_reg(0x4202, 0x0f);
	ov5645b_write_reg(0x3008, 0x42);
}

static int OV5645b_get_sysclk(void)
{
	 /* calculate sysclk */
	int xvclk = ov5645b_data.mclk / 10000;
	int temp1, temp2;
	...
	temp1 = ov5645b_read_reg(0x3034, &temp);
	temp2 = temp1 & 0x0f;
	if (temp2 == 8 || temp2 == 10)
		Bit_div2x = temp2 / 2;

	temp1 = ov5645b_read_reg(0x3035, &temp);
	SysDiv = temp1>>4;
	if (SysDiv == 0)
		SysDiv = 16;

	temp1 = ov5645b_read_reg(0x3036, &temp);
	Multiplier = temp1;

	temp1 = ov5645b_read_reg(0x3037, &temp);
	PreDiv = temp1 & 0x0f;
	Pll_rdiv = ((temp1 >> 4) & 0x01) + 1;

	temp1 = ov5645b_read_reg(0x3108, &temp);
	temp2 = temp1 & 0x03;
...
static void OV5645b_set_night_mode(void)
{
	 /* read HTS from register settings */
	u8 mode;

	ov5645b_read_reg(0x3a00, &mode);
	mode &= 0xfb;
	ov5645b_write_reg(0x3a00, mode);
}

static int OV5645b_get_HTS(void)
{
	 /* read HTS from register settings */
	int HTS;
	u8 temp;

	HTS = ov5645b_read_reg(0x380c, &temp);
	HTS = (HTS<<8) + ov5645b_read_reg(0x380d, &temp);

	return HTS;
}

static int OV5645b_get_VTS(void)
{
	...
	VTS = ov5645b_read_reg(0x380e, &temp);

	VTS = (VTS<<8) + ov5645b_read_reg(0x380f, &temp);

	return VTS;
}

static int OV5645b_set_VTS(int VTS)
{
	 /* write VTS to registers */
	 int temp;

	 temp = VTS & 0xff;
	 ov5645b_write_reg(0x380f, temp);

	 temp = VTS>>8;
	 ov5645b_write_reg(0x380e, temp);

	 return 0;
}

static int OV5645b_get_shutter(void)
{
	 /* read shutter, in number of line period */
	int shutter;
	u8 temp;

	shutter = (ov5645b_read_reg(0x03500, &temp) & 0x0f);
	shutter = (shutter<<8) + ov5645b_read_reg(0x3501, &temp);
	shutter = (shutter<<4) + (ov5645b_read_reg(0x3502, &temp)>>4);

	 return shutter;
}

static int OV5645b_set_shutter(int shutter)
{
	 ...
	 temp = shutter & 0x0f;
	 temp = temp<<4;
	 ov5645b_write_reg(0x3502, temp);

	 temp = shutter & 0xfff;
	 temp = temp>>4;
	 ov5645b_write_reg(0x3501, temp);

	 temp = shutter>>12;
	 ov5645b_write_reg(0x3500, temp);

	 return 0;
}

static int OV5645b_get_gain16(void)
{
	 /* read gain, 16 = 1x */
	int gain16;
	u8 temp;

	gain16 = ov5645b_read_reg(0x350a, &temp) & 0x03;
	gain16 = (gain16<<8) + ov5645b_read_reg(0x350b, &temp);

	return gain16;
}

static int OV5645b_set_gain16(int gain16)
{
	/* write gain, 16 = 1x */
	u8 temp;
	gain16 = gain16 & 0x3ff;
	...
	temp = gain16 & 0xff;
	ov5645b_write_reg(0x350b, temp);

	temp = gain16>>8;
	ov5645b_write_reg(0x350a, temp);

	return 0;
}

static int OV5645b_get_light_freq(void)
{
	/* get banding filter value */
	int temp, temp1, light_freq = 0;
	u8 tmp;

	temp = ov5645b_read_reg(0x3c01, &tmp);

	if (temp & 0x80) {
		/* manual */
		temp1 = ov5645b_read_reg(0x3c00, &tmp);
		if (temp1 & 0x04) {
			/* 50Hz */
			light_freq = 50;
		} else {
		...
		/* auto */
		temp1 = ov5645b_read_reg(0x3c0c, &tmp);
		if (temp1 & 0x01) {
			/* 50Hz */
			light_freq = 50;
		} else {
...
static void OV5645b_set_bandingfilter(void)
{
	int prev_VTS;
	int band_step60, max_band60, band_step50, max_band50;

	/* read preview PCLK */
	prev_sysclk = OV5645b_get_sysclk();
	/* read preview HTS */
	prev_HTS = OV5645b_get_HTS();

	/* read preview VTS */
	prev_VTS = OV5645b_get_VTS();

	/* calculate banding filter */
	/* 60Hz */
	band_step60 = prev_sysclk * 100/prev_HTS * 100/120;
	ov5645b_write_reg(0x3a0a, (band_step60 >> 8));
	ov5645b_write_reg(0x3a0b, (band_step60 & 0xff));

	max_band60 = (int)((prev_VTS-4)/band_step60);
	ov5645b_write_reg(0x3a0d, max_band60);

	/* 50Hz */
	band_step50 = prev_sysclk * 100/prev_HTS;
	ov5645b_write_reg(0x3a08, (band_step50 >> 8));
	ov5645b_write_reg(0x3a09, (band_step50 & 0xff));

	max_band50 = (int)((prev_VTS-4)/band_step50);
	ov5645b_write_reg(0x3a0e, max_band50);
}

static int OV5645b_set_AE_target(int target)
{
	/* stable in high */
	...
	ov5645b_write_reg(0x3a0f, AE_high);
	ov5645b_write_reg(0x3a10, AE_low);
	ov5645b_write_reg(0x3a1b, AE_high);
	ov5645b_write_reg(0x3a1e, AE_low);
	ov5645b_write_reg(0x3a11, fast_high);
	ov5645b_write_reg(0x3a1f, fast_low);

	return 0;
}

static void OV5645b_turn_on_AE_AG(int enable)
{
	u8 ae_ag_ctrl;

	ov5645b_read_reg(0x3503, &ae_ag_ctrl);
	if (enable) {
		/* turn on auto AE/AG */
	...
	ov5645b_write_reg(0x3503, ae_ag_ctrl);
}

static bool binning_on(void)
{
	u8 temp;
	ov5645b_read_reg(0x3821, &temp);
	temp &= 0xfe;
	if (temp)
		return true;
	else
...
static void ov5645b_set_virtual_channel(int channel)
{
	u8 channel_id;

	ov5645b_read_reg(0x4814, &channel_id);
	channel_id &= ~(3 << 6);
	ov5645b_write_reg(0x4814, channel_id | (channel << 6));
}

/* download ov5645b settings to sensor through i2c */
static int ov5645b_download_firmware(struct reg_value *pModeSetting, s32 ArySize)
{
	...
	for (i = 0; i < ArySize; ++i, ++pModeSetting) {
		...
		if (Mask) {
			retval = ov5645b_read_reg(RegAddr, &RegVal);
			if (retval < 0)
				goto err;
		...
		retval = ov5645b_write_reg(RegAddr, Val);
		if (retval < 0)
			goto err;
...
static void ov5645b_dnld_af_fw(void)
{
	...
	pModeSetting = ov5645b_af_setting;
	ArySize = ARRAY_SIZE(ov5645b_af_setting);
	retval = ov5645b_download_firmware(pModeSetting, ArySize);
 ...
 */
static int ov5645b_change_mode_exposure_calc(enum ov5645b_frame_rate frame_rate,
				enum ov5645b_mode mode)
{
	struct reg_value *pModeSetting = NULL;
	s32 ArySize = 0;
	...
	pModeSetting =
		ov5645b_mode_info_data[frame_rate][mode].init_data_ptr;
	ArySize =
		ov5645b_mode_info_data[frame_rate][mode].init_data_size;

	ov5645b_data.pix.width =
		ov5645b_mode_info_data[frame_rate][mode].width;
	ov5645b_data.pix.height =
		ov5645b_mode_info_data[frame_rate][mode].height;

	if (ov5645b_data.pix.width == 0 || ov5645b_data.pix.height == 0 ||
		pModeSetting == NULL || ArySize == 0)
		return -EINVAL;

	/* auto focus */
	/* OV5645b_auto_focus();//if no af function, just skip it */

	/* turn off AE/AG */
	OV5645b_turn_on_AE_AG(0);

	/* read preview shutter */
	prev_shutter = OV5645b_get_shutter();
	if ((binning_on()) && (mode != ov5645b_mode_720P_1280_720)
			&& (mode != ov5645b_mode_1080P_1920_1080))
		prev_shutter *= 2;

	/* read preview gain */
	prev_gain16 = OV5645b_get_gain16();

	/* get average */
	ov5645b_read_reg(0x56a1, &average);

	/* turn off night mode for capture */
	OV5645b_set_night_mode();

	/* turn off overlay */
	/* ov5645b_write_reg(0x3022, 0x06);//if no af function, just skip it */
	...
	/* read capture VTS */
	cap_VTS = OV5645b_get_VTS();
	cap_HTS = OV5645b_get_HTS();
	cap_sysclk = OV5645b_get_sysclk();

	/* calculate capture banding filter */
	light_freq = OV5645b_get_light_freq();
	if (light_freq == 60) {
		/* 60Hz */
	...
	/* write capture gain */
	OV5645b_set_gain16(cap_gain16);

	/* write capture shutter */
	if (cap_shutter > (cap_VTS - 4)) {
		cap_VTS = cap_shutter + 4;
		OV5645b_set_VTS(cap_VTS);
	}
	OV5645b_set_shutter(cap_shutter);
 ...
 * */
static int ov5645b_change_mode_direct(enum ov5645b_frame_rate frame_rate,
				enum ov5645b_mode mode)
{
	struct reg_value *pModeSetting = NULL;
	s32 ArySize = 0;
	...
	OV5645b_turn_on_AE_AG(1);

err:
	return retval;
}

static int ov5645b_init_mode(enum ov5645b_frame_rate frame_rate,
			    enum ov5645b_mode mode, enum ov5645b_mode orig_mode)
{
	struct reg_value *pModeSetting = NULL;
	s32 ArySize = 0;
	int retval = 0;
	u32 msec_wait4stable = 0;
	enum ov5645b_downsize_mode dn_mode, orig_dn_mode;

	if ((mode > ov5645b_mode_MAX || mode < ov5645b_mode_MIN)
		&& (mode != ov5645b_mode_INIT)) {
		pr_err("Wrong ov5645b mode detected!\n");
		return -1;
	}

	dn_mode = ov5645b_mode_info_data[frame_rate][mode].dn_mode;
	orig_dn_mode = ov5645b_mode_info_data[frame_rate][orig_mode].dn_mode;
	if (mode == ov5645b_mode_INIT) {
		pModeSetting = ov5645b_init_setting_30fps_VGA;
		ArySize = ARRAY_SIZE(ov5645b_init_setting_30fps_VGA);

		ov5645b_data.pix.width = 2592;
		ov5645b_data.pix.height = 1944;
		ov5645b_data.loaded_fps = ov5645b_15_fps;
		ov5645b_data.loaded_mode = ov5645b_mode_QSXGA_2592_1944;

		retval = ov5645b_download_firmware(pModeSetting, ArySize);
		if (retval < 0)
			goto err;

		pModeSetting = ov5645b_setting_15fps_QSXGA_2592_1944;
		ArySize = ARRAY_SIZE(ov5645b_setting_15fps_QSXGA_2592_1944);
		retval = ov5645b_download_firmware(pModeSetting, ArySize);
		...
		retval = ov5645b_change_mode_exposure_calc(frame_rate, mode);
	} else {
		/* change inside subsampling or scaling
		 * download firmware directly */
		retval = ov5645b_change_mode_direct(frame_rate, mode);
	}

	if (retval < 0)
		goto err;

	OV5645b_set_AE_target(AE_Target);
	OV5645b_get_light_freq();
	OV5645b_set_bandingfilter();
	ov5645b_set_virtual_channel(ov5645b_data.csi);

	/* add delay to wait for sensor stable */
	if (mode == ov5645b_mode_QSXGA_2592_1944) {
...
/*!
 * ov5645b_s_power - V4L2 sensor interface handler for VIDIOC_S_POWER ioctl
 ...
 */
static int ov5645b_s_power(struct v4l2_subdev *sd, int on)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	struct ov5645b *sensor = to_ov5645b(client);
...
/*!
 * ov5645b_g_parm - V4L2 sensor interface handler for VIDIOC_G_PARM ioctl
 * @s: pointer to standard V4L2 sub device structure
 * @a: pointer to standard V4L2 VIDIOC_G_PARM ioctl structure
 *
 * Returns the sensor's video CAPTURE parameters.
 */
static int ov5645b_g_parm(struct v4l2_subdev *sd, struct v4l2_streamparm *a)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	struct ov5645b *sensor = to_ov5645b(client);
 ...
 * appropriate error code.
 */
static int ov5645b_s_parm(struct v4l2_subdev *sd, struct v4l2_streamparm *a)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	struct ov5645b *sensor = to_ov5645b(client);
	struct v4l2_fract *timeperframe = &a->parm.capture.timeperframe;
	u32 tgt_fps;	/* target frames per secound */
	enum ov5645b_frame_rate frame_rate;
	enum ov5645b_mode orig_mode;
	int ret = 0;
	...
	case V4L2_BUF_TYPE_VIDEO_CAPTURE:
		...
		if (tgt_fps == 15)
			frame_rate = ov5645b_15_fps;
		else if (tgt_fps == 30)
			frame_rate = ov5645b_30_fps;
		else {
		...
		if ((u32)a->parm.capture.capturemode == 0) {
			a->parm.capture.capturemode = get_capturemode(ov5645b_data.pix.width,
				ov5645b_data.pix.height);
		}

		orig_mode = ov5645b_data.loaded_mode;
		if ((orig_mode != (u32)a->parm.capture.capturemode) ||
				(frame_rate != ov5645b_data.loaded_fps)) {
			ret = ov5645b_init_mode(frame_rate,
		...
		ov5645b_data.loaded_mode = a->parm.capture.capturemode;
		ov5645b_data.loaded_fps = frame_rate;
		break;
...
static int ov5645b_set_fmt(struct v4l2_subdev *sd,
			struct v4l2_subdev_pad_config *cfg,
			struct v4l2_subdev_format *format)
{
	struct v4l2_mbus_framefmt *mf = &format->format;
	const struct ov5645b_datafmt *fmt = ov5645b_find_datafmt(mf->code);
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	struct ov5645b *sensor = to_ov5645b(client);
	int capturemode;

	if (!fmt) {
		mf->code	= ov5645b_colour_fmts[0].code;
		mf->colorspace	= ov5645b_colour_fmts[0].colorspace;
	}
	...
	if (capturemode >= 0) {
		ov5645b_data.streamcap.capturemode = capturemode;
		ov5645b_data.pix.width = mf->width;
		ov5645b_data.pix.height = mf->height;
		return 0;
	}
...
static int ov5645b_get_fmt(struct v4l2_subdev *sd,
			  struct v4l2_subdev_pad_config *cfg,
			  struct v4l2_subdev_format *format)
{
	struct v4l2_mbus_framefmt *mf = &format->format;
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	struct ov5645b *sensor = to_ov5645b(client);
	const struct ov5645b_datafmt *fmt = sensor->fmt;
	...
	mf->width	= ov5645b_data.pix.width;
	mf->height	= ov5645b_data.pix.height;

	return 0;
}

static int ov5645b_enum_mbus_code(struct v4l2_subdev *sd,
				 struct v4l2_subdev_pad_config *cfg,
				 struct v4l2_subdev_mbus_code_enum *code)
{
	if (code->pad || code->index >= ARRAY_SIZE(ov5645b_colour_fmts))
		return -EINVAL;

	code->code = ov5645b_colour_fmts[code->index].code;
	return 0;
}

/*!
 * ov5645b_enum_framesizes - V4L2 sensor interface handler for
 ...
 */
static int ov5645b_enum_framesizes(struct v4l2_subdev *sd,
			       struct v4l2_subdev_pad_config *cfg,
			       struct v4l2_subdev_frame_size_enum *fse)
{
	if (fse->index > ov5645b_mode_MAX)
		return -EINVAL;

	fse->max_width =
			max(ov5645b_mode_info_data[0][fse->index].width,
			    ov5645b_mode_info_data[1][fse->index].width);
	fse->min_width = fse->max_width;
	fse->max_height =
			max(ov5645b_mode_info_data[0][fse->index].height,
			    ov5645b_mode_info_data[1][fse->index].height);
	fse->min_height = fse->max_height;
	return 0;
}

static int ov5645b_queryctrl(struct v4l2_subdev *sd, struct v4l2_queryctrl *qc)
{
	return -EINVAL;
}

/*!
 * ov5645b_enum_frameintervals - V4L2 sensor interface handler for
 ...
 * Return 0 if successful, otherwise -EINVAL.
 */
static int ov5645b_enum_frameintervals(struct v4l2_subdev *sd,
		struct v4l2_subdev_pad_config *cfg,
		struct v4l2_subdev_frame_interval_enum *fie)
{
	int i, j, count = 0;

	if (fie->index < 0 || fie->index > ov5645b_mode_MAX)
		return -EINVAL;
	...
	count = 0;
	for (i = 0; i < ARRAY_SIZE(ov5645b_mode_info_data); i++) {
		for (j = 0; j < (ov5645b_mode_MAX + 1); j++) {
			if (fie->width == ov5645b_mode_info_data[i][j].width
			 && fie->height == ov5645b_mode_info_data[i][j].height
			 && ov5645b_mode_info_data[i][j].init_data_ptr != NULL) {
				count++;
			}
			if (fie->index == (count - 1)) {
				fie->interval.denominator =
						ov5645b_framerates[i];
				return 0;
			}
		}
	}
...
static int init_device(void)
{
	...
	ov5645b_data.on = true;

	/* mclk */
	tgt_xclk = ov5645b_data.mclk;
	tgt_xclk = min(tgt_xclk, (u32)OV5645b_XCLK_MAX);
	tgt_xclk = max(tgt_xclk, (u32)OV5645b_XCLK_MIN);
	ov5645b_data.mclk = tgt_xclk;

	pr_debug("   Setting mclk to %d MHz\n", tgt_xclk / 1000000);

	/* Default camera frame rate is set in probe */
	tgt_fps = ov5645b_data.streamcap.timeperframe.denominator /
		  ov5645b_data.streamcap.timeperframe.numerator;
	...
	ret = ov5645b_init_mode(frame_rate, ov5645b_mode_INIT, ov5645b_mode_INIT);

	return ret;
}

static int ov5645b_s_stream(struct v4l2_subdev *sd, int enable)
{
	if (enable)
		OV5645b_stream_on();
	else
...
static struct v4l2_subdev_video_ops ov5645b_subdev_video_ops = {
	.g_parm = ov5645b_g_parm,
	.s_parm = ov5645b_s_parm,
	.s_stream = ov5645b_s_stream,
};

static const struct v4l2_subdev_pad_ops ov5645b_subdev_pad_ops = {
	.enum_frame_size       = ov5645b_enum_framesizes,
	.enum_frame_interval   = ov5645b_enum_frameintervals,
	.enum_mbus_code        = ov5645b_enum_mbus_code,
	.set_fmt               = ov5645b_set_fmt,
	.get_fmt               = ov5645b_get_fmt,
};

static struct v4l2_subdev_core_ops ov5645b_subdev_core_ops = {
	.s_power	= ov5645b_s_power,
#ifdef CONFIG_VIDEO_ADV_DEBUG
	.g_register	= ov5645b_get_register,
	.s_register	= ov5645b_set_register,
#endif
	.queryctrl	= ov5645b_queryctrl,
};

static struct v4l2_subdev_ops ov5645b_subdev_ops = {
	.core	= &ov5645b_subdev_core_ops,
	.video	= &ov5645b_subdev_video_ops,
	.pad	= &ov5645b_subdev_pad_ops,
};

static void ov5645b_adjust_setting_20mhz(void)
{
	struct reg_value *regsetting;
	int i, array_size;

	/* adjust for INIT mode */
	regsetting = ov5645b_init_setting_30fps_VGA;
	array_size = ARRAY_SIZE(ov5645b_init_setting_30fps_VGA);
...
static int ov5645b_set_regs(const char *buffer, struct kernel_param *kp)
{
	// Use this sysfs node to set the ov5645b isp regs by sending it a
	...
	while (in_string != NULL) {
		...
		retval = ov5645b_write_reg(reg_addr & 0xffff, value & 0xff);
...
static int ov5645b_set_print_reg(const char *buffer, struct kernel_param *kp)
{
	int cnt;
...
static int ov5645b_get_print_reg(char *buffer, struct kernel_param *kp)
{
	int cnt, retval;
	u8 val;
	if (reg_addr_to_read == 0)
		return 0;
	retval = ov5645b_read_reg(reg_addr_to_read & 0xffff, &val);
	if (retval < 0)
		return 0;
...
static int ov5645b_set_af_mode(const char *buffer, struct kernel_param *kp)
{
	int cnt, val;
	cnt = sscanf(buffer, "%d", &val);

	switch (val) {
	case ov5645b_af_release:
		ov5645b_release_af();
		break;
	case ov5645b_af_lock:
		ov5645b_lock_af();
		break;
	case ov5645b_af_cont:
		ov5645b_enable_cont_af();
		break;
	default:
...
static int ov5645b_read_af(char *buffer, struct kernel_param *kp)
{
	int cnt, retval;
	u8 val;
	retval = ov5645b_read_reg(0x3029, &val);

	cnt = sprintf(buffer, "%d", (unsigned int)val & 0xff);
	return cnt;
}

static int ov5645b_get_initialized(char *buffer, struct kernel_param *kp)
{
	int cnt;
	cnt = sprintf(buffer, "%d", ov5645b_data.initialized ? 1 : 0);
	return cnt;
}

module_param_call(ov5645b_set_regs, ov5645b_set_regs, NULL, NULL, 0644);
module_param_call(ov5645b_print_reg, ov5645b_set_print_reg, ov5645b_get_print_reg,
		NULL, 0644);
module_param_call(ov5645b_af, ov5645b_set_af_mode, ov5645b_read_af, NULL, 0644);
module_param_call(ov5645b_initialized, NULL, ov5645b_get_initialized, NULL, 0644);
...
/*!
 * ov5645b I2C probe function
 *
 * @param adapter            struct i2c_adapter *
 * @return  Error code indicating success or failure
 */
static int ov5645b_probe(struct i2c_client *client,
			const struct i2c_device_id *id)
{
	...
	memset(&ov5645b_data, 0, sizeof(ov5645b_data));
	ov5645b_data.sensor_clk = devm_clk_get(dev, "csi_mclk");
	if (IS_ERR(ov5645b_data.sensor_clk)) {
		/* assuming clock enabled by default */
		ov5645b_data.sensor_clk = NULL;
		dev_err(dev, "clock-frequency missing or invalid\n");
		return PTR_ERR(ov5645b_data.sensor_clk);
	}
	...
	if (ov5645b_data.mclk == OV5645b_XCLK_20MHZ)
		ov5645b_adjust_setting_20mhz();

	retval = of_property_read_u32(dev->of_node, "mclk_source",
					(u32 *) &(ov5645b_data.mclk_source));
	if (retval) {
	...
	clk_prepare_enable(ov5645b_data.sensor_clk);

	ov5645b_data.io_init = ov5645b_reset;
	ov5645b_data.i2c_client = client;
	ov5645b_data.pix.pixelformat = V4L2_PIX_FMT_YUYV;
	ov5645b_data.pix.width = 640;
	ov5645b_data.pix.height = 480;
	ov5645b_data.streamcap.capability = V4L2_MODE_HIGHQUALITY |
					   V4L2_CAP_TIMEPERFRAME;
	ov5645b_data.streamcap.capturemode = 0;
	ov5645b_data.streamcap.timeperframe.denominator = DEFAULT_FPS;
	ov5645b_data.streamcap.timeperframe.numerator = 1;

	ov5645b_regulator_enable(&client->dev);

	ov5645b_reset();

	ov5645b_power_down(0);

	retval = ov5645b_read_reg(OV5645b_CHIP_ID_HIGH_BYTE, &chip_id_high);
	if (retval < 0 || chip_id_high != 0x56) {
		pr_warning("camera ov5645b_mipi is not found\n");
		clk_disable_unprepare(ov5645b_data.sensor_clk);
		return -ENODEV;
	}
	retval = ov5645b_read_reg(OV5645b_CHIP_ID_LOW_BYTE, &chip_id_low);
	...
	if (retval < 0) {
		clk_disable_unprepare(ov5645b_data.sensor_clk);
		pr_warning("camera ov5645b init failed\n");
		ov5645b_power_down(1);
		return retval;
	}

	v4l2_i2c_subdev_init(&ov5645b_data.subdev, client, &ov5645b_subdev_ops);

	ov5645b_data.subdev.grp_id = 678;
	retval = v4l2_async_register_subdev(&ov5645b_data.subdev);
	if (retval < 0)
		dev_err(&client->dev,
	...
	pr_info("camera ov5645b_mipi is found\n");
	ov5645b_data.initialized = true;
	return retval;
}

/*!
 * ov5645b I2C detach function
 *
...
module_i2c_driver(ov5645b_i2c_driver);

MODULE_AUTHOR("Freescale Semiconductor, Inc.");
MODULE_DESCRIPTION("OV5645b MIPI Camera Driver");
MODULE_LICENSE("GPL");
MODULE_VERSION("1.0");
MODULE_ALIAS("CSI");
