...
static const struct hid_blacklist {
	...
	{ USB_VENDOR_ID_CORSAIR, USB_DEVICE_ID_CORSAIR_M65_PRO_RGB, HID_QUIRK_NO_INIT_REPORTS },
	{ USB_VENDOR_ID_CORSAIR, USB_DEVICE_ID_CORSAIR_GLAIVE_RGB, HID_QUIRK_NO_INIT_REPORTS | HID_QUIRK_ALWAYS_POLL },
